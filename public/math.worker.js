...
// ---------------------------------------------------------------------------
// 1. GENERIC 4TH-ORDER RUNGE-KUTTA (RK4) NUMERICAL INTEGRATOR (Float64)
// ---------------------------------------------------------------------------
/**
 * Steps state vector y forward by dt using 4th-Order Runge-Kutta.
 * f(t, y, params, dydt): computes derivatives into Float64Array dydt
 * Truncation error: local O(dt^5), global accumulated O(dt^4)
 */
...
// ---------------------------------------------------------------------------
// 2. DOMAIN-SPECIFIC FLOAT64 ODE SOLVERS & KINEMATIC KERNELS
// ---------------------------------------------------------------------------

/** RLC Resonant Circuit (EE-200) */
...
/** DC-DC Buck-Boost Converter (EE-200) */
...
/** Sallen-Key Active Filter (EE-200) */
