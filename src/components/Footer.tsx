...
export const Footer: React.FC<FooterProps> = ({ 
  ...
  const handleContactSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.set('name', 'Quick Inquirer');
    formData.set('category', 'general');
    formData.set('subject', 'Quick In-Page Contact Form');
          ...
          >
            ...
            {contactSubmitted ? (
              ...
              >
                ...
                <input type="hidden" name="name" value="Quick Inquirer" />
                <input type="hidden" name="category" value="general" />
                <input type="hidden" name="subject" value="Quick In-Page Contact Form" />
                <p className="hidden" aria-hidden="true">
                  <label>Don’t fill this out: <input name="bot-field" tabIndex={-1} autoComplete="off" /></label>
                </p>

                <div className="flex items-center justify-between text-slate-400 text-xs">
                  <span>Reach out directly to Anil Sharma.</span>
                  {onNavigateToContact && (
                    <button
                      type="button"
                      onClick={() => {
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:outline-none focus:border-cyan-500 font-mono text-xs disabled:opacity-50"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:outline-none focus:border-cyan-500 text-xs disabled:opacity-50"
                  />
                </div>
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={contactIsSubmitting}
                    className="px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs font-display flex items-center gap-1.5 transition-colors disabled:opacity-60"
                  >
                    <Send className="w-3 h-3" />
                    <span>{contactIsSubmitting ? 'Sending...' : 'Send Message'}</span>
                  </button>
                </div>
              </form>
            )}
